                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  image: DecorationImage(
                                    image:
                                        const AssetImage('assets/pozadina1.webp'),
                                    fit: BoxFit.cover,
                                              ...
                                              children: [
                                                TextButton(
                                                  ...
                                                  child: Text(
                                                    'Home',
                                                    style: GoogleFonts.poppins(
                                                                               color: const Color.fromARGB(255, 6, 184, 121),
                                                ...
                                                TextButton(
                                                  onPressed: () async {if (katCnt.currentContext != null) {
...
,
                     ...
                     SizedBox(  height: 12),
                      ...
                      child: GoogleMap(  key: lokacijaCnt,),
                    ),
                    Container(
   ...
   endDrawer: Drawer(
     child: Container(
       color: const Color(0xFF808080).withOpacity(0.2), // Set the background color for the drawer
       child: ListView(
         children: [
  ...
  if (homeCnt.currentContext != null) {
    Scrollable.ensureVisible(
      ...
      duration: const Duration(milliseconds: 500), // Adjust the duration as needed
           ...
           Container(
       color: const Color(0xFF808080).withOpacity(0.3), // Set the background color for the drawer
